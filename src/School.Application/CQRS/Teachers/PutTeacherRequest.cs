...
{
    public class PutTeacherRequest : IRequest<Teacher>
    {
    ...
    public class PutTeacherRequestHandler : IRequestHandler<PutTeacherRequest, Teacher>
    {
        ...
        public async Task<Teacher> Handle(PutTeacherRequest request, CancellationToken cancellationToken)
        {
            ...
            if (areas.Count == 0)
                throw new HttpRequestException("KnowledgeArea ids are invalid or empty. It's not possible to update a Teacher with no KnowledgeArea.",
